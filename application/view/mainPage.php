...
<body id="body" class="d-flex flex-column h-100">
	<div class="flex-shrink-0">
				...
				<div class="col-sm-12">
					<div id="main_3d_image">
						<div id="main_text" class="col-xs-12 col-sm-4">
							<div id="title_home"><?php echo "<h2>".$data['mainTitle']['title']."</h2>"?></div>
							<div id="subtitle_home"><?php echo "<h3>".$data['mainTitle']['subtitle']."</h3>"?></div>
							<div id="description_home"><?php echo "<p>".$data['mainTitle']['description']."</p>"?></div>
						</div>
					</div>
				</div>
			</div>
		...
		<div id="further" class="container-fluid main_contents">
			<div class="col-sm-12">
				<p>Use of "for ($i = 0; $i < count($data['MainBrands']); $i++){" to set up html and reduce redundant code significantly</p></br>
				<p>Use of naming conventions (e.g. RotZ-TIMERCoke, RotZ-TIMERCosta, RotZ-TIMERFanta) to enable javascript like document.querySelectorAll('[id$=Model]'); to target all appropriate models</p></br>
				<p>Use of multiple functions in controller to fetch all the data from different tables which is then passed to this view.</p></br>
				...
				<p>Coke model particularly detailed with regular dips in model. Lid has extra detail. </p> </br>
				<p>Attempted to use blender, as seen in _3DModelling, successfully did a model but the model won't export properly to X3D. Additionally, files are approximately 10+ times larger, which would slow loading times and consume ram</p>
			</div>
		</div>
				...
				<div class="col-sm-4">
					<div class="card">
						...
						<div class="card-body">
							...
							<a href="#" class="btn btn-outline-dark btn-responsive" onclick="cameraSwitch('Front');"><i class="fas fa-undo fa-2x"></i></a>
							<a href="#" class="btn btn-outline-dark btn-responsive" onclick="cameraSwitch('Back');"><i class="fas fa-angle-down fa-2x"></i></a>
							<a href="#" class="btn btn-outline-dark btn-responsive" onclick="cameraSwitch('Left');"><i class="fas fa-angle-left fa-2x"></i></a>
							<a href="#" class="btn btn-outline-dark btn-responsive" onclick="cameraSwitch('Right');"><i class="fas fa-angle-right fa-2x"></i></a>
							<a href="#" class="btn btn-outline-dark btn-responsive" onclick="cameraSwitch('Top');"><i class="fas fa-angle-up fa-2x"></i></a>
				...
				<div class="col-sm-4">
					<div class="card">
						...
						<div class="card-body">
							...
							<a href="#" class="btn btn-outline-dark btn-responsive btn-anim" onclick="spin('Y');">Y</a>
							<a href="#" class="btn btn-outline-dark btn-responsive btn-anim" onclick="spin('Z');">Z</a>
							...
							<ul class="nav nav-tabs card-header-tabs">
								...
								<li class="nav-item dropdown">
									...
									<div class="dropdown-menu">
										...
										<a class="dropdown-item" href="#" onclick="cameraLeft();">Target On/Off</a>
